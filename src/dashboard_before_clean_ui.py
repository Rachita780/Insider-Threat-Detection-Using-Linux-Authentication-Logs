...
# -------------------------------------------------
# Threat Type Function
# -------------------------------------------------

def get_threat_type(issue):
    """
    Convert the detailed alert explanation into
    a simple threat category for visualization.
    """
...
if uploaded_file is not None:
    ...
    for user, issues in threats.items():
        ...
        for issue in issues:
            ...
            if threat_type in threat_distribution:
    ...
    if chart_data:
        ...
        st.caption(
            "The chart shows the number of alerts "
            "detected for each suspicious activity type."
        )
        ...
        st.info(
            ...
            "because no suspicious activity was detected."
        )
